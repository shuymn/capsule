...
- `task package:check` runs `cargo package --workspace --list --quiet --allow-dirty` to catch missing or stale version requirements on workspace path dependencies before release automation runs.
